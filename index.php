...
<head>
  ...
  <link rel="stylesheet" href="style/webinar.css">
	...
	<!-- Google Analytics -->
	<script async src="https://www.googletagmanager.com/gtag/js?id=G-4NYH4W2S83"></script>
	<script>
		window.dataLayer = window.dataLayer || [];
		function gtag(){window.dataLayer.push(arguments);}
		gtag('js', new Date());

		gtag('config', 'G-4NYH4W2S83');
	</script>
</head>
...
<body>
  ...
  <script type="text/javascript" src="js/data/funding.js"></script>
	...
	<script type="text/javascript" src="js/data/summer-fellows-2016.js"></script>
        <script type="text/javascript" src="js/data/summer-fellows-2017.js"></script>
	<script type="text/javascript" src="js/data/summer-fellows-2018.js"></script>
        <script type="text/javascript" src="js/data/summer-fellows-2019.js"></script>
