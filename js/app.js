var mod = angular.module("lincsDcic", [
  ...
  "Concierge",
	...
	"summerFellows2018Mod",
	"summerFellows2019Mod",
 	"webinarsMod",
 	"workshopsEtcMod",
	"ui.bootstrap"
]);
...
mod.config(["$routeProvider", "$locationProvider", function($routeProvider, $locationProvider) {
	$routeProvider.
		...
		when("/summer-fellows-2018", {
      			templateUrl: "view/page/summer-fellows-2018.html"
    		}).
		when("/summer-fellows-2019", {
      			templateUrl: "view/page/summer-fellows-2019.html"
		}).
		when("/internal-dsrp", {
