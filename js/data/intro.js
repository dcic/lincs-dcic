    ...
    $scope.sections = [
        {
            ...
            text:  $sce.trustAsHtml("<p>The objective of the Data Science Research (DSR) component of the BD2K-LINCS DCIC is to develop methods that would further extract knowledge from <a href='http://www.lincsproject.org/data/data-releases/' target='_blank'>LINCS data</a> by integrating LINCS data with other relevant resources. The integration of LINCS perturbation data with other datasets will help us unravel the mode of action (MOA) of perturbations which is expected not to become readily possible to obtain by processing the LINCS data alone. Understanding and extracting new knowledge from MOA network models created from LINCS data integrated with other resources will facilitate drug repositioning strategies, identification of new drugs and targets, as well as help in predicting deleterious effects of relevant perturbations. Our data science projects will address methodological and computational challenges related to such integrative analyses.</p><p>The BD2K-LINCS DCIC has several <a href='http://lincs-dcic.org/#/internal-dsrp#nav' target='_blank'>internal research projects</a> and supports several <a href='http://lincs-dcic.org/#external-dsrp#nav' target='_blank'>external data science research projects</a>, addressing various data integration and intracellular molecular regulatory network challenges. The Center aims to develop: 1) methods to connect cellular and organismal phenotypes with molecular cellular signatures, and 2) novel data visualization methods for dynamically interacting with large-genomics and proteomics datasets.</p>"),
